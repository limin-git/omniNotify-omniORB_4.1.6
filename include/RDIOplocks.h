...
#ifndef NDEBUG
  inline static int ptr_exists(RDIOplockEntry* ptr) 
  {
	  _oplock_ptrhash.lock();
	  int ret = _dbg_ptrs.exists(ptr); 
	  _oplock_ptrhash.unlock();
	  return ret;
  }
#endif
...
private:
  ...
  static _nfy_attr TW_Mutex          _oplock_ptrhash;
